...
var_class = pd.read_csv(sys_path+data_path+'/VariableClassification.csv',usecols=['Type','Variable'])
var_class.set_index('Variable',inplace=True)

cov_matrix2016 = pd.read_csv(sys_path+data_path+'cov_matrix_'+t+'2016'+'_cut.csv',index_col=[0])
cov_matrix2018 = pd.read_csv(sys_path+data_path+'cov_matrix_'+t+'2018'+'_cut.csv',index_col=[0])
cov_matrix2020 = pd.read_csv(sys_path+data_path+'cov_matrix_'+t+'2020'+'_cut.csv',index_col=[0])
...
with sns.axes_style('white'):
    ...
    ax.axis('off')
    nx.draw_networkx(Network2016[0],with_labels=False, node_color=color_map,
                   node_size=100, alpha=0.7, edge_color='lightgray',
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(Network2018[0],with_labels=False, node_color=color_map,
                   node_size=100, alpha=0.7, edge_color='lightgray',
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(Network2020[0],with_labels=False, node_color=color_map,
                   node_size=100, alpha=0.7, edge_color='lightgray',
...
sns.despine()
sns.scatterplot(data=Fuerza, x=Fuerza.index, y='Fuerza', hue='Año', style='Tipo', s=60, markers=['X','o'])
...
d2016 = pd.DataFrame({'Grado':x[0],'x_grado':equis, 'Fuerza':xx[0], 'x_fuerza':equis_2, 'Año':'2016'})
...
equis = [x[1][i]+(x[1][1]-x[1][0]) for i in range(0,len(x[1])-1)]
equis_2 = [xx[1][i]+(xx[1][1]-xx[1][0]) for i in range(0,len(xx[1])-1)]
d2018 = pd.DataFrame({'Grado':x[0],'x_grado':equis, 'Fuerza':xx[0], 'x_fuerza':equis_2,'Año':'2018'})
...
equis = [x[1][i]+(x[1][1]-x[1][0]) for i in range(0,len(x[1])-1)]
equis_2 = [xx[1][i]+(xx[1][1]-xx[1][0]) for i in range(0,len(xx[1])-1)]
d2020 = pd.DataFrame({'Grado':x[0],'x_grado':equis, 'Fuerza':xx[0], 'x_fuerza':equis_2, 'Año':'2020'})
...
ax.tick_params(labelsize=fontsize_ticks)
sns.despine()
sns.scatterplot(data=d, x='x_grado', y='Grado', hue='Año', style='Año', s=80, alpha=0.7, edgecolor='black')
...
ax.tick_params(labelsize=fontsize_ticks)
sns.despine()
sns.scatterplot(data=d, x='x_fuerza', y='Fuerza', hue='Año', style='Año', s=80, alpha=0.7, edgecolor='black')
...
ax.tick_params(labelsize=fontsize_ticks)
sns.scatterplot(data=C2016[1], x=C2016[1].index,y='Modularidad',
             hue='No Comunidades', size='No Comunidades', style='No Comunidades',
...
ax.spines['top'].set_visible(False)
ax.tick_params(labelsize=fontsize_ticks)
sns.scatterplot(data=C2018[1], x=C2018[1].index,y='Modularidad',
             hue='No Comunidades', size='No Comunidades',
                style='No Comunidades',palette='Set2', edgecolor=None)
plt.xlabel('No iteración', fontsize=fontsize_ticks)
plt.ylabel('$Q$', fontsize=fontsize_ticks)
...
ax.spines['top'].set_visible(False)
ax.tick_params(labelsize=fontsize_ticks)
sns.scatterplot(data=C2020[1], x=C2020[1].index,y='Modularidad',
             hue='No Comunidades', size='No Comunidades',
                style='No Comunidades',palette='Set2', edgecolor=None)
plt.xlabel('No iteración', fontsize=fontsize_ticks)
plt.ylabel('$Q$', fontsize=fontsize_ticks)
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(Network2016[0],with_labels=False,
                   node_size=100, alpha=0.7, edge_color='lightgray', node_color=color_map,
                    pos=nx.fruchterman_reingold_layout(Network2016[0], seed=seed))
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(Network2018[0],with_labels=False,
                   node_size=100, alpha=0.7, edge_color='lightgray', node_color=color_map,
                    pos=nx.fruchterman_reingold_layout(Network2018[0], seed=seed))
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(Network2020[0],with_labels=False,
                   node_size=100, alpha=0.7, edge_color='lightgray', node_color=color_map,
                    pos=nx.fruchterman_reingold_layout(Network2020[0], seed=seed))
...
CH_codes = {'MAdultos':'M1','MAdultosMenores':'M2','MAdultosMayores':'M3',
           'MMayoresMenores':'M4','MMayores':'M5','MAdultosMayoresMenores':'M6',
           'HAdultos':'H1','HAdultosMenores':'H2','HAdultosMayores':'H3',
           'HMayoresMenores':'H4','HMayores':'H5','HAdultosMayoresMenores':'H6'}
...
sns.stripplot(data=Nodesyr,x='Año',y='Nodes',
              hue='Presencia',ax=ax, s=10, linewidth=1,cmap='jet')
...
ax.spines['top'].set_visible(False)
ax.tick_params(labelsize=fontsize_ticks)
sns.histplot(data=Nodesyr[Nodesyr.Type!='CH'].sort_values(by='Año',ascending=True),
             x='Año',y='Type',palette='Set2',discrete=(True,True),
            cbar=True, cbar_kws=dict(shrink=.75),stat='count')
...
ax.spines['top'].set_visible(False)
ax.tick_params(labelsize=fontsize_ticks)
sns.scatterplot(data=Group1,x='Año',y='Nodes',hue='Presencia',
                ax=ax, s=150,edgecolor='black')
...
ax.spines['top'].set_visible(False)
ax.tick_params(labelsize=fontsize_ticks)
sns.histplot(data=Group1[Group1.Type!='CH'],x='Año',y='Type',palette='Set2',discrete=(True,True),
...
ax.spines['top'].set_visible(False)
ax.tick_params(labelsize=fontsize_ticks)
sns.scatterplot(data=Group2,x='Año',y='Nodes',hue='Presencia',
                ax=ax, s=150,edgecolor='black')
plt.xticks(['2016','2018','2020'], fontsize=fontsize_ticks+10)
plt.xlabel('', fontsize=fontsize_ticks+10)
plt.ylabel('', fontsize=fontsize_ticks)
...
ax.spines['top'].set_visible(False)
ax.tick_params(labelsize=fontsize_ticks)
sns.histplot(data=Group2[Group2.Type!='CH'],x='Año',y='Type',palette='Set2',discrete=(True,True),
            cbar=True, cbar_kws=dict(shrink=.75))
plt.xticks(['2016','2018','2020'], fontsize=fontsize_ticks+5)
plt.yticks(fontsize=fontsize_ticks+5)
plt.xlabel('', fontsize=fontsize_ticks+10)
...
ax.spines['top'].set_visible(False)
ax.tick_params(labelsize=fontsize_ticks)
sns.scatterplot(data=Group3,x='Año',y='Nodes',hue='Presencia',
                ax=ax, s=150,edgecolor='black')
plt.xticks(['2016','2018','2020'], fontsize=fontsize_ticks+10)
plt.xlabel('', fontsize=fontsize_ticks+10)
plt.ylabel('', fontsize=fontsize_ticks)
...
ax.spines['top'].set_visible(False)
ax.tick_params(labelsize=fontsize_ticks)
sns.histplot(data=Group3[Group3.Type!='CH'],x='Año',y='Type',palette='Set2',discrete=(True,True),
            cbar=True, cbar_kws=dict(shrink=.75))
plt.xticks(['2016','2018','2020'], fontsize=fontsize_ticks+5)
plt.yticks(fontsize=fontsize_ticks+5)
plt.xlabel('', fontsize=fontsize_ticks+10)
...
ax.spines['top'].set_visible(False)
ax.tick_params(labelsize=fontsize_ticks)
sns.scatterplot(data=Group4,x='Año',y='Nodes',hue='Presencia',
                ax=ax, s=150,edgecolor='black')
plt.xticks(['2016','2018','2020'], fontsize=fontsize_ticks+10)
plt.xlabel('', fontsize=fontsize_ticks+10)
plt.ylabel('', fontsize=fontsize_ticks)
...
ax.spines['top'].set_visible(False)
ax.tick_params(labelsize=fontsize_ticks)
sns.histplot(data=Group4[Group4.Type!='CH'],x='Año',y='Type',palette='Set2',discrete=(True,True),
            cbar=True, cbar_kws=dict(shrink=.75))
plt.xticks(['2016','2018','2020'], fontsize=fontsize_ticks+5)
plt.yticks(fontsize=fontsize_ticks+5)
plt.xlabel('', fontsize=fontsize_ticks+10)
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(c2016_1,with_labels=True,
                   node_size=300, alpha=1, edge_color='lightgray', node_color='blue',
...
with sns.axes_style('white'):
    ...
    ax.axis('off')
    nx.draw_networkx(c2016_2,with_labels=True,
                   node_size=150, alpha=1, edge_color='lightgray', node_color='orange',
                    pos=nx.fruchterman_reingold_layout(c2016_2,seed=seed), font_size=8)
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(c2016_3,with_labels=True,
                   node_size=300, alpha=1, edge_color='lightgray', node_color='green',
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(c2016_4,with_labels=True,
                   node_size=300, alpha=1, edge_color='lightgray', node_color='red',
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(c2018_1,with_labels=True,
                   node_size=300, alpha=1, edge_color='lightgray', node_color='blue',
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8.2*1.618,8.2))
    ax.axis('off')
    nx.draw_networkx(c2018_2,with_labels=True,
                   node_size=300, alpha=1, edge_color='lightgray', node_color='orange',
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(c2018_3,with_labels=True,
                   node_size=300, alpha=1, edge_color='lightgray', node_color='green',
                    pos=nx.fruchterman_reingold_layout(c2018_3,seed=seed),font_size=9)
plt.title('Comunidad 3')
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(c2018_4,with_labels=True,
                   node_size=300, alpha=1, edge_color='lightgray', node_color='red',
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(c2020_1,with_labels=True,
                   node_size=300, alpha=1, edge_color='lightgray', node_color='blue',
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8.2*1.618,8.2))
    ax.axis('off')
    nx.draw_networkx(c2020_2,with_labels=True,
                   node_size=300, alpha=1, edge_color='lightgray', node_color='orange',
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8*1.618,8))
    ax.axis('off')
    nx.draw_networkx(c2020_3,with_labels=True,
                   node_size=300, alpha=1, edge_color='lightgray', node_color='green',
                    pos=nx.fruchterman_reingold_layout(c2020_3,seed=seed),font_size=9)
plt.title('Comunidad 3')
...
with sns.axes_style('white'):
    f,ax=plt.subplots(figsize=(8.2*1.618,8.2))
    ax.axis('off')
    nx.draw_networkx(c2020_4,with_labels=True,
                   node_size=150, alpha=1, edge_color='lightgray', node_color='red',
                    pos=nx.fruchterman_reingold_layout(c2020_4,seed=seed), font_size=9)
plt.title('Comunidad 4')
